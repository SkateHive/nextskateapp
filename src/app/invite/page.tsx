...
import {
    Box, Button, Center, Checkbox, Flex, FormControl,
    Icon, Input, Text, VStack, Switch
        ...
        return (
            <Flex style={{
                ...
                <VStack spacing={3}>
                    ...
                    <Text fontFamily="Creepster" fontSize="32px" color={"yellow"}>Choose Account Creation Method</Text>
                    <Switch isChecked={useAccountToken} onChange={() => setUseAccountToken(!useAccountToken)} />
