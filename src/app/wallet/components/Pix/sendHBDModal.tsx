...
const SendHBDModal: React.FC<SendHBDModalProps> = ({
  ...
  const [formattedPixKeyType, setFormattedPixKeyType] =
    useState<string>(keyType);
  ...
  const sendHBD = async () => {
    ...
    try {
      const result = await keychain.transfer(
  ...
  return (
    ...
    >
      ...
      <ModalContent bg={"black"} color="white">
        ...
        <ModalFooter>
          <Button colorScheme="blue" onClick={sendHBD} isDisabled={loading}>
