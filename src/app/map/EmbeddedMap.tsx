...
const EmbeddedMap: React.FC = () => {
  ...
  const comments = useMemo(() => {
    return allComments.filter(
      (comment) => comment.parent_permlink === parent_permlink
    );
      ...
      >
        ...
        >
          <Head>
            ...
            <meta
              name="description"
              content="Discover the Skatehive Spot Map, a global database for finding and sharing skate spots. Join the community today!"
            />
            <meta
              name="keywords"
              content="skateboarding, skate spots, skate map, global skate spots, skatehive"
            />
          </Head>
          <Heading
            as="h1"
          ...
          <Flex flexDirection={{ base: "column", md: "row" }} align="center">
            ...
            <Box
              ...
              style={{
                backgroundImage:
                  "repeating-linear-gradient(var(--a), #000000, #444444 10vw)",
              }}
            >
              <Flex
                flexDirection="column"
              ...
              >
                <Text fontSize={{ base: "md", md: "lg" }} color="white" mb={3}>
                  This skatespot database started in 2012. The{" "}
                ...
                <Text fontSize={{ base: "md", md: "lg" }} color="white" mb={3}>
                  If you would like to add a spot, upload a photo of the spot
                  below. When a mod approves your photo, it will be added to the
                  spotbook. Some tips on submitting a spot:
                </Text>
                <Text fontSize={{ base: "md", md: "lg" }} color="white" mb={3}>
                  Take a photo of the spot. Try not to include people in the
                  photo. Find the coordinates of the spot. Latitude, then
                  Longitude. Bake the GPS coordinates into the photo by turning
                  location services on with Photos on your phone. Login and
                  submit the spot.
                </Text>
              </Flex>
            </Box>
