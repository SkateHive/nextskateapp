...
const ImproveWithAiModal = memo(function ImproveWithAiModal({
  isOpen,
  onClose,
  improveWithAi,
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} isCentered>
      ...
      <ModalContent bg={"black"} color={"white"}>
        ...
        <ModalCloseButton />
        <Center>
          <Image src="/brain.png" alt="AI" boxSize={"88px"} />
        </Center>
        <ModalBody>
            ...
            <Box key={index} borderWidth="1px" borderRadius="lg" p={4} mb={4}>
              <VStack>
                ...
                <HStack>
                  ...
                  {replacedIndexes[index] && <FaCheck color="green" />}
                </HStack>
              </VStack>
