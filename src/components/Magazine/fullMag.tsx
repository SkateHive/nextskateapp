...
const AuthorAvatar = lazy(() => import("@/components/AuthorAvatar"));
const MarkdownRenderer = lazy(() => import("@/components/ReactMarkdown/page"));
...
const coverStyles = {
  ...
  background:
    "linear-gradient(120deg,rgba(56, 161, 105, 0.6),rgb(5, 5, 5) 100%)",
  color: neonGreen,
...
export default function FullMag({ tag, query }: FullMagProps) {
  ...
  const filteredPosts = useMemo(() => {
    ...
    return posts
      ...
      .sort(
        (a, b) =>
          Number(getTotalPayout(b as any)) - Number(getTotalPayout(a as any))
      );
  }, [posts]);
  ...
  if (isLoading) {
    return (
      <Flex justify="center" align="center" w="100vw" h="100vh" p={5}>
        <Text color={"white"}>
          Use your mouse to flip pages and scroll the pages
        </Text>
      </Flex>
    );
  }
        ...
        <Box sx={coverStyles}>
          <Flex direction="column" align="center" justify="center" h="100%">
            ...
            <Heading
              ...
              letterSpacing="tight"
              mb={2}
              style={{ ...retroFont, textShadow: neonShadow, color: neonGreen }}
            >
              SkateHive Magazine
            </Heading>
            <Text
              ...
              color={neonGreen}
              mb={4}
              style={{ ...retroFont, textShadow: neonShadow }}
            >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Text fontSize="xs" color="#A6E22E" style={{ ...retroFont }}>
              ...
              <MarkdownRenderer
                key={post.id}
                content={post.body}
                renderers={FullMagazineRenderers}
                className="page"
              />
              <Divider mt={4} mb={4} />
