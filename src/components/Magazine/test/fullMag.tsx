...
import { Box, Heading, Text, Divider, Flex, Image, Center, HStack, VStack } from '@chakra-ui/react';
...
export default function FullMag({ tag, query }: TestPageProps) {
    ...
    return (
        <VStack justify="center" align="center" w="100%" h="100vh" p={5}>
            <HTMLFlipBook
                width={500} // numeric value
                height={750} // numeric value
                minWidth={0}
                maxWidth={500} // numeric value
                minHeight={0}
                maxHeight={750} // numeric value
                startPage={0}
                size='stretch'
                drawShadow
                flippingTime={1000}
