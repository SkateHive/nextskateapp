...
import { Button, Center, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, useMediaQuery } from '@chakra-ui/react';
   ...
   const handleSave = (username: string) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size={{ base: "lg", md: "2xl", lg: "6xl" }} >
            ...
            {isPreview ? (
                <ModalContent bg={'#1A202C'} border={"1px solid #2D3748"} color="white">
                <ModalHeader>
